## SafeHouse — Permanent structure on the map.
## Refugees within attraction_radius will pathfind toward it.
## Refugees that enter the rescue radius are considered "rescued."
